...
const KEYWORD_MAP = [
    ...
    { kw: ['pvr', 'inox', 'bookmyshow', 'movie', 'movies', 'cinema', 'film', 'theatre', 'concert', 'gaming', 'pub', 'bar', 'club', 'comedy', 'cricket', 'match', 'stadium', 'amusement', 'park', 'outing', 'trip', 'picnic'], cat: 'entertainment' },
